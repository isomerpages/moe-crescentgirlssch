...
**1\. How does this program benefit my school?**<br>
...
**2. What is the commitment level for the Teacher Coding Champion?**<br>
...
**3. Is there any registration fee or other cost to participate in the program?**<br>
There is no registration fee for the program. However, schools will need to provide iPads installed with the Swift Playgrounds app if students do not have their own personal device.

**4: Do I need a device to participate in this program?**<br>
Yes. Students will need to have **an iPad that is updated to iPadOS 15.2 or later** to run the latest version of **Swift Playgrounds**.
...
**5: How do I tell what is the device my school I have?**<br>
On your iPad, go into **_Settings > General > About_**. You will be able to see the model name as well as the software version installed in your device.

**6. What if students do not complete the entire program?**<br>
Students must complete both Phase 1 and Phase 2 in order to be awarded the e-certificate of participation.

**7. Can I look at the contents before I sign my students up for the program?**<br>
Please refer to the Outline of activities in SLS for Phase 1 and 2 above.<br>
Please contact us at **[ses@crescent.edu.sg](mailto:ses@crescent.edu.sg)** if you need more information.

**8. Who will be monitoring the progress of students?**<br>
The nominated Teacher Coding Champion will be the main coordinator for participating schools. SLS packages will be shared with the Teacher Coding Champion for assignment to the participating teams of students in the school. While the activities are designed to support Self-Directed Learning (SDL), the Teacher Coding Champions should arrange for milestone check-ins with the participating students to ensure that they are on-task and make progress.
